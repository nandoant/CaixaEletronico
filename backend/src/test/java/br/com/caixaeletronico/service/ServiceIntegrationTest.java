...
class ServiceIntegrationTest {
    ...
    void deveExecutarOperacaoCompletaDeDepositoComAtualizacaoDeEstoque() {
        ...
        estoqueGlobalService.adicionarCedulas(ValorCedula.CEM, 5);
    ...
    void deveImpedirSaqueQuandoEstoqueInsuficiente() {
        ...
        boolean estoqueDisponivel = estoqueGlobalService.verificarDisponibilidade(ValorCedula.CEM, 10);
    ...
    void deveProcessarTransferenciaEntreContas() {
        ...
        verify(contaRepository, times(3)).findById(contaOrigemId);
    ...
    void deveGerarOperacoesConsistentesNoExtrato() {
        ...
        assertThat(ultimasOperacoes.get(0).getTipo()).isEqualTo(TipoOperacao.DEPOSITO);
