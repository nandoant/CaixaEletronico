...
public class ContaInfoDto {
    ...
    private BigDecimal saldo; // opcional - apenas quando apropriado
    
    // Construtor sem saldo (para operações que não devem expor saldo)
    ...
    // Construtor com saldo (para consultas de saldo, extrato e operações admin)
    public ContaInfoDto(Long contaId, String numeroConta, String titular, 
                       String usuarioProprietario, Long usuarioProprietarioId, 
                       BigDecimal saldo) {
        this.contaId = contaId;
